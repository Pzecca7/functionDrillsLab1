...
function faveColorFinder (color){
  if(color === `red`){
    ...
    return(`green is a solid favorite color`)
      ...
      return (`you need to evaluate yout favorite color choice`)
...
console.log(emailCheck(`pzecca94@gmail.com`))
...
let chocolateFrogPrice = 3
 ...
 function buyChocolateFrogs (num){
  return num / chocolateFrogPrice
 }

totalFrogs = buyChocolateFrogs(35)
...
function buyChocolateFrogs2 (num){
  return Math.floor(num / chocolateFrogPrice)
}

totalFrogs = buyChocolateFrogs2(35)
